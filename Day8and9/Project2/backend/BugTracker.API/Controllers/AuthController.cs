...
namespace BugTracker.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IConfiguration configuration, ILogger<AuthController> logger, BugTrackerContext context, PasswordHasher<User> passwordHasher)
        {
        ...
        {
            var users = await _context.Users.Select(u => new { u.Username, u.Role }).ToListAsync();
            return Ok(users);
        }
    }
}